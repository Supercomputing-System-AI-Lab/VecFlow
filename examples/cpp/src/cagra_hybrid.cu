...
void cagra_ivf_build_search_variants(shared_resources::configured_raft_resources& dev_resources,
  ...
  std::string cagra_index_file = "/scratch/bdes/cmo1/CAGRA/indices_yfcc/index_32_16.bin";
  std::string graph_file = "/scratch/bdes/cmo1/CAGRA/indices_yfcc/graph_32_16.bin";
  std::string ivf_index_file = "/scratch/bdes/cmo1/CAGRA/filtered_ivf_indices_yfcc/spec_" + 
